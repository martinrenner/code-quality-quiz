class AsciiArt:
    def draw_square(self, width: int, symbol: str) -> str:
        ...
        Args:
            ...
            symbol (str): The symbol used to fill the square.
    ...
    def draw_rectangle(self, width: int, height: int, symbol: str) -> str:
        ...
        Args:
            ...
            symbol (str): The symbol used to fill the rectangle.
    ...
    def draw_circle(self, diameter: int, symbol: str) -> str:
        ...
        Args:
            ...
            symbol (str): The symbol used to fill the circle.
    ...
    def draw_triangle(self, width: int, height: int, symbol: str) -> str:
        ...
        Args:
            ...
            symbol (str): The symbol used to fill the triangle.
    ...
    def draw_pyramid(self, height: int, symbol: str) -> str:
        ...
        for i in range(height):
            spaces = ' ' * (height - i - 1)
            filled = symbol * (2 * i + 1)
            result.append(spaces + filled + spaces)
        return "\n".join(result)
